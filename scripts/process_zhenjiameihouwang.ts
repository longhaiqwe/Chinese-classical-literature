...
const SUPABASE_KEY = process.env.SUPABASE_SERVICE_ROLE_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inl2ZnR6d3hpaXloaGVhb3lreGdjIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjcwNzA1NzIsImV4cCI6MjA4MjY0NjU3Mn0.s5tWDl76OAxd6lH9sRrE0eHzHwfv71GvWfEpvZfz7H0';
const BUCKET_NAME = 'story-assets';

// Dirs
const SOURCE_DIR = path.join(process.cwd(), "public/assets/xiyouji/zhenjiameihouwang");
const TEMP_DIR = path.join(process.cwd(), 'temp_assets_zhenjia');
const TARGET_SUBDIR = 'xiyouji/zhenjiameihouwang';

// File Mapping (Source Filename -> Target Filename)
const IMAGE_MAP = [
    { src: '01.png', target: 'bg_01_exile.jpg' },
    { src: '02.png', target: 'bg_02_battle.jpg' },
    { src: '03.png', target: 'bg_03_guanyin.jpg' },
    { src: '04.png', target: 'bg_04_diting.jpg' },
    { src: '05.png', target: 'bg_05_buddha.jpg' },
    { src: 'Success.png', target: 'bg_06_reunion.jpg' },
    { src: 'failure.png', target: 'bg_06_failure.jpg' }
];
...
async function main() {
    ...
    for (const item of IMAGE_MAP) {
        ...
        try {
            // sips -s format jpeg --resampleWidth 1024 --cropToHeightWidth 576 1024
    ...
    for (const file of processedFiles) {
        ...
        const storagePath = path.join(TARGET_SUBDIR, file);
