...
// Dirs
const SOURCE_DIR = path.join(process.cwd(), "public/assets/sanguoyanyi/caochuanjiejian");
const TEMP_DIR = path.join(process.cwd(), 'temp_assets');
const TARGET_SUBDIR = 'sanguoyanyi/caochuanjiejian';

// File Mapping (Source Filename -> Target Filename)
const IMAGE_MAP = [
    { src: '01.png', target: 'bg_01_request.jpg' },
    { src: '02.png', target: 'bg_02_plan.jpg' },
    { src: '03.png', target: 'bg_03_fog.jpg' },
    { src: '04.png', target: 'bg_04_arrows.jpg' },
    { src: '05.png', target: 'bg_05_return.jpg' },
    { src: '06.png', target: 'bg_06_execution.jpg' }
];
