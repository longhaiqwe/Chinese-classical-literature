...
DO $$
DECLARE
  v_cat_sanguo text := 'sanguoyanyi';
  v_cat_xiyou text := 'xiyouji';
  v_cat_shanhai text := 'shanhaijing';
  v_cat_lunyu text := 'lunyu';
  v_scene_id uuid;
BEGIN
  INSERT INTO categories (id, title, cover_image, sort_order) VALUES ('sanguoyanyi', '三国演义', '/assets/covers/cover_sanguo.jpg', 1) ON CONFLICT (id) DO UPDATE SET sort_order=1;
  INSERT INTO categories (id, title, cover_image, sort_order) VALUES ('xiyouji', '西游记', '/assets/covers/cover_xiyou.jpg', 2) ON CONFLICT (id) DO UPDATE SET sort_order=2;
  INSERT INTO categories (id, title, cover_image, sort_order) VALUES ('shanhaijing', '山海经', '/assets/covers/cover_shanhai.jpg', 3) ON CONFLICT (id) DO UPDATE SET sort_order=3;
  INSERT INTO categories (id, title, cover_image, sort_order) VALUES ('lunyu', '论语', '/assets/covers/cover_lunyu.jpg', 4) ON CONFLICT (id) DO UPDATE SET sort_order=4;
  INSERT INTO stories (id, category_id, title, description, ending_title, ending_description, sort_order) VALUES ('sangumaolu', v_cat_sanguo, '三顾茅庐', '刘备三次拜访诸葛亮，求贤若渴，终得隆中对。', '如鱼得水', '刘备三顾茅庐，终得卧龙出山。此后君臣相知，如鱼得水，共创蜀汉基业。', 1) ON CONFLICT (id) DO NOTHING;
  INSERT INTO stories (id, category_id, title, description, ending_title, ending_description, sort_order) VALUES ('taoyuan', v_cat_sanguo, '桃园结义', '东汉末年，天下大乱。刘关张三人于桃园结义，共图大事。', '义薄云天', '三位英雄于桃园焚香结拜，誓同生死。一段波澜壮阔的三国史诗就此拉开序幕。恭喜你完成了这段历史的演绎。', 2) ON CONFLICT (id) DO NOTHING;
  INSERT INTO stories (id, category_id, title, description, ending_title, ending_description, sort_order) VALUES ('danaotiangong', v_cat_xiyou, '大闹天宫', '孙悟空大闹天宫，挑战十万天兵天将。', '齐天大圣', '十万天兵难抵挡，定海神针显神威。这一战，打出了齐天大圣的赫赫威名，也种下了五百年被压五行山的因果。', 1) ON CONFLICT (id) DO NOTHING;
  INSERT INTO stories (id, category_id, title, description, sort_order) VALUES ('sandabaigujing', v_cat_xiyou, '三打白骨精 (敬请期待)', '白骨精三次变化戏弄唐僧，悟空火眼金睛识破妖魔。', 2) ON CONFLICT (id) DO NOTHING;
  INSERT INTO stories (id, category_id, title, description, sort_order) VALUES ('zhenjiameihouwang', v_cat_xiyou, '真假美猴王 (敬请期待)', '六耳猕猴假冒悟空，上天入地难辨真伪，终至如来佛祖处方显原形。', 3) ON CONFLICT (id) DO NOTHING;
  INSERT INTO stories (id, category_id, title, description, sort_order) VALUES ('nuerguo', v_cat_xiyou, '女儿国奇遇 (敬请期待)', '师徒误入西梁女国，唐僧在女王柔情与取经大业之间经受考验。', 4) ON CONFLICT (id) DO NOTHING;
  INSERT INTO stories (id, category_id, title, description, sort_order) VALUES ('dazhanhonghaier', v_cat_xiyou, '大战红孩儿 (敬请期待)', '红孩儿练成三昧真火，悟空难敌，请来观音菩萨方才收服。', 5) ON CONFLICT (id) DO NOTHING;
  INSERT INTO stories (id, category_id, title, description, sort_order) VALUES ('touchirenshenguo', v_cat_xiyou, '偷吃人参果 (敬请期待)', '万寿山五庄观，悟空偷吃人参果，推倒果树，惹怒镇元大仙。', 6) ON CONFLICT (id) DO NOTHING;
  INSERT INTO stories (id, category_id, title, description, ending_title, ending_description, sort_order) VALUES ('jingweitianhai', v_cat_shanhai, '精卫填海', '炎帝之女溺亡东海，化为精卫鸟，衔石填海，矢志不渝。', '坚韧不拔', '精卫衔微木，将以填沧海。刑天舞干戚，猛志固常在。你的坚持与毅力，正如这精卫鸟一般，令人动容。', 1) ON CONFLICT (id) DO NOTHING;
  INSERT INTO stories (id, category_id, title, description, sort_order) VALUES ('houyisheri', v_cat_shanhai, '后羿射日 (敬请期待)', '十日并出，焦禾稼，杀草木。后羿张弓搭箭，射落九日，解救苍生。', 2) ON CONFLICT (id) DO NOTHING;
  INSERT INTO stories (id, category_id, title, description, sort_order) VALUES ('kuafuzhuri', v_cat_shanhai, '夸父逐日 (敬请期待)', '夸父与日逐走，渴欲得饮，饮于河、渭；河、渭不足，北饮大泽，未至，道渴而死。', 3) ON CONFLICT (id) DO NOTHING;
  INSERT INTO stories (id, category_id, title, description, sort_order) VALUES ('dayuzhishui', v_cat_shanhai, '大禹治水 (敬请期待)', '大禹率民治水，三过家门而不入，疏通九河，平定水患。', 4) ON CONFLICT (id) DO NOTHING;
  INSERT INTO stories (id, category_id, title, description, sort_order) VALUES ('huangdizhan', v_cat_shanhai, '黄帝战蚩尤 (敬请期待)', '轩辕黄帝与蚩尤大战于逐鹿之野，风后设指南车破迷雾，最终统一华夏。', 5) ON CONFLICT (id) DO NOTHING;
  INSERT INTO stories (id, category_id, title, description, ending_title, ending_description, sort_order) VALUES ('yanhuitouzhou', v_cat_lunyu, '颜回偷粥', '孔子误会颜回偷食，终知真相。通过此事感叹“知人不易”。', '知人不易', '所信者目也，而目犹不可信；所恃者心也，而心犹不足恃。弟子记之，知人固不易矣。', 1) ON CONFLICT (id) DO NOTHING;
  INSERT INTO stories (id, category_id, title, description, sort_order) VALUES ('weibiansanjue', v_cat_lunyu, '韦编三绝 (敬请期待)', '孔子晚年喜读《易》，韦编三绝。曰：“假我数年，五十以学《易》，可以无大过矣。”', 2) ON CONFLICT (id) DO NOTHING;
  INSERT INTO stories (id, category_id, title, description, sort_order) VALUES ('zilushoujiao', v_cat_lunyu, '子路受教 (敬请期待)', '子路问政，孔子教之以先之劳之。子路性直，孔子常循循善诱。', 3) ON CONFLICT (id) DO NOTHING;
  INSERT INTO stories (id, category_id, title, description, sort_order) VALUES ('shizherusi', v_cat_lunyu, '逝者如斯 (敬请期待)', '子在川上曰：“逝者如斯夫！不舍昼夜。” 感叹时光流逝，勉励弟子珍惜光阴。', 4) ON CONFLICT (id) DO NOTHING;
  INSERT INTO stories (id, category_id, title, description, sort_order) VALUES ('junzibuqi', v_cat_lunyu, '君子不器 (敬请期待)', '孔子曰：“君子不器。” 意为君子博学多才，不应像器物一样只有单一用途。', 5) ON CONFLICT (id) DO NOTHING;
  -- sangumaolu
  INSERT INTO scenes (story_id, scene_index, title, narrative, environment_description, character_state, image_url) VALUES ('sangumaolu', 1, '初访隆中', '汉末乱世，刘备求贤若渴，闻听司马徽推荐诸葛亮之名，遂携关羽、张飞前往隆中拜访。只见山不高而秀雅，水不深而澄清，地不广而平坦，林不大而茂盛。三人来到草庐门前，叩门问童子，童子应声而出。刘备恭敬询问先生所在。', 'A serene thatched cottage in the mountains, surrounded by pine and bamboo.', 'Liu Bei asking a young servant boy.', '/assets/sanguoyanyi/sangumaolu/bg_01_visit1.png') RETURNING id INTO v_scene_id;
  ...
  INSERT INTO scenes (story_id, scene_index, title, narrative, environment_description, character_state, image_url) VALUES ('sangumaolu', 2, '风雪再访', '时值隆冬，天降大雪。刘备探得孔明归家，不顾天寒地冻，冒雪再去。张飞曰：“天寒地冻，且非用兵之时，何必受此劳苦？”刘备呵斥之。至门前，闻草堂书声琅琅，刘备心中暗喜，以为即是孔明。', 'Snowy landscape, Liu Bei waiting respectfully outside.', 'Liu Bei standing in the snow.', '/assets/sanguoyanyi/sangumaolu/bg_02_visit2.png') RETURNING id INTO v_scene_id;
  ...
  INSERT INTO scenes (story_id, scene_index, title, narrative, environment_description, character_state, image_url) VALUES ('sangumaolu', 3, '三顾草庐', '开春之际，刘备选定吉期，斋戒沐浴，三往隆中。凡门，童子曰：“先生昼寝未醒。”刘备当即大喜，令关张在门外等候，自己轻步入内。见先生仰卧于草堂几席之上，那般神态安详。', 'Springtime at the cottage, peace and quiet.', 'Liu Bei waiting while Zhuge Liang sleeps.', '/assets/sanguoyanyi/sangumaolu/bg_03_visit3.png') RETURNING id INTO v_scene_id;
  ...
  INSERT INTO scenes (story_id, scene_index, title, narrative, environment_description, character_state, image_url) VALUES ('sangumaolu', 4, '隆中对·相见', '孔明更衣出迎，见刘备气宇轩昂，诚意拳拳。分宾主坐定，童子献茶。刘备言：“汉室倾颓，奸臣窃命，主上蒙尘。备不量力，欲伸大义于天下，而智术浅短，迄无所就。惟先生开其愚而拯其厄。”', 'Interior of the cottage, simple but elegant. Liu Bei and Zhuge Liang sitting face to face.', 'Liu Bei bowing respectfully to Zhuge Liang.', '/assets/sanguoyanyi/sangumaolu/bg_04_meeting.png') RETURNING id INTO v_scene_id;
  ...
  INSERT INTO scenes (story_id, scene_index, title, narrative, environment_description, character_state, image_url) VALUES ('taoyuan', 7, '平行时空：孤身落魄', '虽有心报国，然行差踏错，终是孤身一人。桃园之义未成，天下大势亦随之而变...', 'Lonely figure walking away in the snow.', 'Liu Bei walking away alone.', '/assets/sanguoyanyi/taoyuan/bg_07_bad_lonely.jpg') RETURNING id INTO v_scene_id;
  INSERT INTO scene_options (scene_id, text, is_correct, feedback, sort_order) VALUES (v_scene_id, '重新来过', true, '往事已矣，来者可追。', 1);

  -- danaotiangong
  INSERT INTO scenes (story_id, scene_index, title, narrative, environment_description, character_state, image_url) VALUES ('danaotiangong', 1, '龙宫借宝', '孙悟空学艺归来，占山为王，虽有神通，却手无寸铁。闻听东海龙宫宝物众多，遂入海求兵。老龙王先后奉上大捍刀、九股叉、画杆方天戟，悟空皆大摇其头，嫌兵器太轻，不称手。', 'Splendid underwater Dragon Palace with various weapons displayed.', 'Sun Wukong rejecting conventional weapons.', '/assets/xiyouji/danaotiangong/bg_01_dragon_palace.jpg') RETURNING id INTO v_scene_id;
  ...
  INSERT INTO scenes (story_id, scene_index, title, narrative, environment_description, character_state, image_url) VALUES ('danaotiangong', 3, '地府销名', '悟空得了金箍棒，日日在花果山操练，好不快活。一日醉卧松阴，魂魄被黑白无常勾至幽冥界。悟空醒来大怒，掏出金箍棒，一路打入森罗殿，逼十代冥王取出此时生死簿。', 'Gloomy Underworld court with terrified judges.', 'Sun Wukong checking the Book of Life and Death.', '/assets/xiyouji/danaotiangong/bg_03_underworld.jpg') RETURNING id INTO v_scene_id;
  ...
  INSERT INTO scenes (story_id, scene_index, title, narrative, environment_description, character_state, image_url) VALUES ('danaotiangong', 5, '蟠桃盛会', '悟空回山自封“齐天大圣”。玉帝无奈，只得承认其号，令看管蟠桃园。一日，七仙女来摘桃，言王母设宴请众仙，并未请大圣。悟空大怒，定住七仙女，奔瑶池痛饮仙酒，又偷吃了太上老君的仙丹。', 'Celestial banquet hall in disarray.', 'Sun Wukong drunk and causing chaos.', '/assets/xiyouji/danaotiangong/bg_05_banquet.jpg') RETURNING id INTO v_scene_id;
  ...
  INSERT INTO scenes (story_id, scene_index, title, narrative, environment_description, character_state, image_url) VALUES ('danaotiangong', 7, '平行时空：皈依', '若当初不至龙宫寻宝、地府销名、不闹天宫，安分守己做个弼马温，或许便是另一番光景。但这，还是那个敢爱敢恨、无法无天的齐天大圣吗？', 'Sun Wukong looking bored in heaven.', 'Sun Wukong as a celestial bureaucrat.', '/assets/xiyouji/danaotiangong/bg_07_bad_boring.jpg') RETURNING id INTO v_scene_id;
  ...
  -- jingweitianhai
  INSERT INTO scenes (story_id, scene_index, title, narrative, environment_description, character_state, image_url) VALUES ('jingweitianhai', 1, '离家远游', '上古之时，炎帝神农氏有一爱女，名曰女娃。女娃生性活泼，向往自由。一日，她遥望日出之东方，只见云蒸霞蔚，心中顿生向往，意欲前往东海一游。', 'Morning mist in the mountains, a young girl looking towards the east.', 'Nuwa standing on a hill, looking hopeful.', '/assets/shanhaijing/jingweitianhai/bg_01_departure.jpg') RETURNING id INTO v_scene_id;
  ...
  INSERT INTO scenes (story_id, scene_index, title, narrative, environment_description, character_state, image_url) VALUES ('jingweitianhai', 2, '泛舟戏水', '历经跋涉，女娃终于抵达东海之滨。只见碧波万顷，海天一色。她寻得一叶扁舟，独自划入海中。海风轻拂，波光粼粼，女娃只觉心旷神怡，从未有过的畅快。', 'A beautiful young girl sailing a small boat on a calm sea.', 'Nuwa enjoying the sea breeze.', '/assets/shanhaijing/jingweitianhai/bg_02_sailing.jpg') RETURNING id INTO v_scene_id;
  ...
  INSERT INTO scenes (story_id, scene_index, title, narrative, environment_description, character_state, image_url) VALUES ('jingweitianhai', 4, '溺水化鸟', '轰隆一声巨响，一个如山般的巨浪拍下，小舟瞬间支离破碎。女娃落入冰冷的海水中，渐渐沉没。然而，她的身躯虽殁，怨愤之气不散，精魂化为一只白喙赤足的小鸟，名曰“精卫”。', 'Stormy sea, a bird rising from the waves.', 'Jingwei bird flying defiantly.', '/assets/shanhaijing/jingweitianhai/bg_04_transformation.jpg') RETURNING id INTO v_scene_id;
  ...
  INSERT INTO scenes (story_id, scene_index, title, narrative, environment_description, character_state, image_url) VALUES ('jingweitianhai', 6, '千古誓言', '惊涛骇浪嘲笑它：“尔一小鸟，纵千百万年，也难填平我这汪洋大海。” 精卫在高空厉声回视：“纵使千万年，甚至亿万年，我也誓将你填平，以免你再害他人少年！”', 'Jingwei dropping stones into the vast ocean.', 'Determined bird carrying a stone.', '/assets/shanhaijing/jingweitianhai/bg_06_oath.jpg') RETURNING id INTO v_scene_id;
  ...
  INSERT INTO scenes (story_id, scene_index, title, narrative, environment_description, character_state, image_url) VALUES ('yanhuitouzhou', 2, '颜回讨米', '颜回几经周折，终于讨回一些米来煮粥。大家早已饥肠辘辘，都在焦急地等待。', 'Yan Hui cooking near a simple stove.', 'Yan Hui focused on cooking.', '/assets/lunyu/yanhuitouzhou/bg_02_cooking.jpg') RETURNING id INTO v_scene_id;
  ...
  INSERT INTO scenes (story_id, scene_index, title, narrative, environment_description, character_state, image_url) VALUES ('yanhuitouzhou', 3, '意外发生', '粥快熟时，忽有一阵风吹来，屋顶上的灰尘掉进了锅里。颜回连忙用勺子将脏了的粥舀出来。', 'Dust falling into the pot.', 'Yan Hui looking concerned.', '/assets/lunyu/yanhuitouzhou/bg_03_accident.jpg') RETURNING id INTO v_scene_id;
  ...
  INSERT INTO scenes (story_id, scene_index, title, narrative, environment_description, character_state, image_url) VALUES ('yanhuitouzhou', 4, '孔子试探', '孔子远远看见颜回似乎在偷吃，心中不悦，但没有当面发作。待颜回端粥送上时，孔子故意说道：“刚才我梦见了先君，这粥若是洁净的，就先拿去祭祀吧。”', 'Confucius testing Yan Hui.', 'Confucius looking stern but calm.', '/assets/lunyu/yanhuitouzhou/bg_04_test.jpg') RETURNING id INTO v_scene_id;
  ...
  INSERT INTO scenes (story_id, scene_index, title, narrative, environment_description, character_state, image_url) VALUES ('yanhuitouzhou', 5, '误会冰释', '孔子听后感叹道：“原本我只相信眼睛看到的，可亲眼所见也未必是真相；原本我只依靠内心的推测，可内心有时也会不可靠。大家要记住，了解一个人真的不容易啊！”', 'Confucius teaching his disciples.', 'All disciples listening with respect.', '/assets/lunyu/yanhuitouzhou/bg_05_resolution.jpg') RETURNING id INTO v_scene_id;
