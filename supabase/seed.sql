...
DO $$ DECLARE v_scene_id uuid; BEGIN
  -- houyisheri
  INSERT INTO scenes (story_id, scene_index, title, narrative, environment_description, character_state, image_url) VALUES ('houyisheri', 1, '十日并出', '东方海外，汤谷之中，原有十个太阳，每日轮流值守，照耀大地。然一日，十日竟一同升起，化作十只金乌在天空嬉戏。瞬间大地干裂，河流枯竭，草木焦黄，百姓苦不堪言。', 'Ten suns scorching the earth, rivers drying up, people suffering.', 'People looking at the sky in despair.', 'https://yvftzwxiiyhheaoykxgc.supabase.co/storage/v1/object/public/story-assets/shanhaijing/houyisheri/bg_01_ten_suns.jpg') RETURNING id INTO v_scene_id;
  INSERT INTO scene_options (scene_id, text, is_correct, feedback, sort_order) VALUES (v_scene_id, '躲入地穴，苟且偷生', false, '虽可暂避一时，然大地若毁，地穴岂能独存？且坐视苍生受难，非勇者所为。', 1);
  INSERT INTO scene_options (scene_id, text, is_correct, feedback, sort_order) VALUES (v_scene_id, '祈求上苍，降雨灭火', false, '天帝帝俊乃十日之父，此时正纵容诸子。祈求无用，唯有抗争。', 2);
  INSERT INTO scene_options (scene_id, text, is_correct, feedback, sort_order) VALUES (v_scene_id, '挺身而出，寻找救法', true, '在这绝望之际，神射手后羿看着受难的百姓，紧握手中彤弓素箭，眼中燃起怒火。', 3);


  INSERT INTO scenes (story_id, scene_index, title, narrative, environment_description, character_state, image_url) VALUES ('houyisheri', 2, '帝尧之请', '人间帝王尧见百姓死伤惨重，痛心疾首，遂请天神后羿下界除害。后羿领命，来到昆仑之巅，张弓搭箭，直指苍穹。', 'Emperor Yao pleading with Hou Yi, Hou Yi holding a bow.', 'Hou Yi preparing to shoot.', 'https://yvftzwxiiyhheaoykxgc.supabase.co/storage/v1/object/public/story-assets/shanhaijing/houyisheri/bg_02_emperor_plea.jpg') RETURNING id INTO v_scene_id;
  INSERT INTO scene_options (scene_id, text, is_correct, feedback, sort_order) VALUES (v_scene_id, '直接射杀，不留情面', false, '先礼后兵乃君子之风。金乌虽顽劣，毕竟是神灵之子，应先予警告。', 1);
  INSERT INTO scene_options (scene_id, text, is_correct, feedback, sort_order) VALUES (v_scene_id, '鸣镝示警，劝其归去', true, '后羿射出一支鸣镝，划破长空，意在警告金乌速速归去，勿再为祸人间。', 2);
  INSERT INTO scene_options (scene_id, text, is_correct, feedback, sort_order) VALUES (v_scene_id, '畏惧天帝，不敢开弓', false, '后羿也就是因为这份刚正不阿，才会被贬下凡。既已领命，何惧之有？', 3);


  INSERT INTO scenes (story_id, scene_index, title, narrative, environment_description, character_state, image_url) VALUES ('houyisheri', 3, '金乌顽劣', '那十只金乌见鸣镝飞来，不仅不惧，反而更加肆无忌惮，甚至向后羿喷吐真火，嘲笑其不自量力。', 'Golden crows mocking Hou Yi, spitting fire.', 'Hou Yi angered by the crows'' arrogance.', 'https://yvftzwxiiyhheaoykxgc.supabase.co/storage/v1/object/public/story-assets/shanhaijing/houyisheri/bg_03_mockery.jpg') RETURNING id INTO v_scene_id;
  INSERT INTO scene_options (scene_id, text, is_correct, feedback, sort_order) VALUES (v_scene_id, '再次警告，苦口婆心', false, '此时再言，已被其视为软弱。对付这等顽劣之徒，言语已是无用。', 1);
  INSERT INTO scene_options (scene_id, text, is_correct, feedback, sort_order) VALUES (v_scene_id, '愤而开弓，射落一日', true, '忍无可忍，无需再忍！后羿脚踏大地，手挽雕弓，满月崩弦，一箭射出！', 2);
  INSERT INTO scene_options (scene_id, text, is_correct, feedback, sort_order) VALUES (v_scene_id, '求助天帝，管教诸子', false, '远水难救近火。况且天帝若肯管教，何至于此？', 3);


  INSERT INTO scenes (story_id, scene_index, title, narrative, environment_description, character_state, image_url) VALUES ('houyisheri', 4, '九日坠落', '只听一声惨叫，一只金乌中箭坠落，化为三足乌鸦，身上的火焰瞬间熄灭。余下九日大惊，四散奔逃。后羿神威大发，连珠箭发，一口气又射落八只。', 'Suns falling from the sky one by one.', 'Hou Yi shooting arrows in rapid succession.', 'https://yvftzwxiiyhheaoykxgc.supabase.co/storage/v1/object/public/story-assets/shanhaijing/houyisheri/bg_04_falling_suns.jpg') RETURNING id INTO v_scene_id;
  INSERT INTO scene_options (scene_id, text, is_correct, feedback, sort_order) VALUES (v_scene_id, '乘胜追击，射杀殆尽', false, '万物生长靠太阳。若十日皆亡，大地将陷入永恒的黑暗与严寒，亦是一场浩劫。', 1);
  INSERT INTO scene_options (scene_id, text, is_correct, feedback, sort_order) VALUES (v_scene_id, '因生怜悯，停手不射', false, '剩下那只若不给足教训，难保日后不故态复萌。此时停手，尚嫌太早。', 2);
  INSERT INTO scene_options (scene_id, text, is_correct, feedback, sort_order) VALUES (v_scene_id, '欲射最后一日', true, '后羿搭上最后一支箭，瞄准了最后那只瑟瑟发抖的金乌。', 3);


  INSERT INTO scenes (story_id, scene_index, title, narrative, environment_description, character_state, image_url) VALUES ('houyisheri', 5, '万物复苏', '正当此时，尧帝急忙拦住后羿：“壮士留步！若无太阳，万物亦无法生存。”后羿闻言收弓。最后一只金乌死里逃生，发誓从此每日按时升起，造福万物。从此，风调雨顺，万物复甦。', 'A single sun in the sky, rain falling, plants growing.', 'People celebrating, Hou Yi putting away his bow.', 'https://yvftzwxiiyhheaoykxgc.supabase.co/storage/v1/object/public/story-assets/shanhaijing/houyisheri/bg_05_salvation.jpg') RETURNING id INTO v_scene_id;
  INSERT INTO scene_options (scene_id, text, is_correct, feedback, sort_order) VALUES (v_scene_id, '居功自傲，索要赏赐', false, '后羿射日乃为苍生，非为私利。英雄之所以为英雄，在于其无私。', 1);
  INSERT INTO scene_options (scene_id, text, is_correct, feedback, sort_order) VALUES (v_scene_id, '归隐山林，不问世事', false, '后羿虽立大功，但人世间尚有凿齿、九婴等妖兽为祸，英雄的使命尚未结束。', 2);
  INSERT INTO scene_options (scene_id, text, is_correct, feedback, sort_order) VALUES (v_scene_id, '继续除害，造福苍生', true, '后羿收拾弓箭，又踏上了铲除妖兽、守护大地的征途。他的名字，被后世永远铭记。', 3);


  INSERT INTO scenes (story_id, scene_index, title, narrative, environment_description, character_state, image_url) VALUES ('houyisheri', 6, '平行时空：黑暗永夜', '若后羿一时兴起，将十日尽数射杀，世界从此陷入无尽黑暗，那个英雄，恐将成为千古罪人。', 'Eternal night, frozen world.', 'Hou Yi standing alone in the dark.', 'https://yvftzwxiiyhheaoykxgc.supabase.co/storage/v1/object/public/story-assets/shanhaijing/houyisheri/bg_06_bad_darkness.jpg') RETURNING id INTO v_scene_id;
  INSERT INTO scene_options (scene_id, text, is_correct, feedback, sort_order) VALUES (v_scene_id, '重新来过，手下留情', true, '过犹不及，万事当有度。', 1);
