...
export default function ImageGenerator({ storyId, story, prompts, onBack, onFinish }: ImageGeneratorProps) {
    ...
    return (
        <div className="max-w-6xl mx-auto p-4 md:p-8 bg-[#FDFBF7] font-serif min-h-screen relative">
            <header className="mb-6 md:mb-8 border-b-2 border-accent-red/10 pb-4 md:pb-6 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
                <div>
                    <h2 className="text-2xl md:text-3xl font-calligraphy text-ink-900 mb-2">第六步：图片生成</h2>
                    <p className="text-sm md:text-base text-ink-500">为故事注入视觉灵魂</p>
                </div>
                <div className="flex flex-col md:flex-row gap-2 md:gap-4 w-full md:w-auto">
                    ...
                    <button
                        ...
                        className="w-full md:w-auto px-6 py-2 bg-accent-red text-white rounded hover:bg-red-700 disabled:opacity-50 shadow-md text-center"
                    >
            ...
            {editingScene !== null && (
                <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
                    <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg overflow-hidden flex flex-col max-h-[90vh] mx-4 md:mx-0">
